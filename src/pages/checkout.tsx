            ...
            <main className="w-full px-10 py-20 font-manrope">
                <div className="flex lg:flex-row flex-col gap-16 text-[#1a1c1a]">
                    <section className="space-y-12 lg:w-[60%] w-full">
                        <div>
                            <h1 className="md:text-[48px] text-[25px] leading-12 tracking-[-1.2px] font-noto font-bold">Select Payment Method</h1>
                            <p className="md:text-[16px] text-[14px] leading-6 text-[#504441]">Choose your preferred way to complete your purchase at our atelier.</p>
                        </div>
                    ...
                    <section>
                        <div className="bg-[#F4F3F1] space-y-8 lg:px-10 py-10 px-5 rounded-2xl">
                            <h2 className="font-bold md:text-[24px] text-[20px] font-noto leading-8">Order Summary</h2>
                            ...
                            <div className="pt-6">
                                ...
                                <div className="flex justify-between items-center">
                                    <p className="font-noto md:text-[30px] text-[25px] leading-7.5 font-bold">₦422,500</p>
                                    <p className="text-[#504441] text-[12px] leading-4 font-manrope">VAT included</p>
                                </div>
                            </div>
                            <div className="bg-[#50444115] text-[#504441] font-manrope text-[12px] leading-4.75 flex gap-3 md:p-4 p-1 rounded-xl">
                                <Award className="text-primary" size={40} />
                                <p className="md:text-[16px] text-[12px]">Every purchase at Trustora is backed by our authenticity guarantee and premium delivery service.</p>
                            </div>
                        </div>
                    </section>
                </div>
