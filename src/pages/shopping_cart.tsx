        ...
        <div className="flex flex-col">
            ...
            <main className="flex-1 pt-20 px-6 font-manrope">
                <section className="space-y-4 mb-12">
                    <h1 className="font-noto font-bold text-[48px] text-[#1A1C1A] leading-15 tracking-[-1.5px]">Your Shopping Bag</h1>
                    <p className="text-[18px] leading-7 text-[#827470]">2 items carefully curated for your beauty ritual.</p>
                </section>
                <section className="flex gap-y-10 md:flex-row flex-col justify-between text-[#1a1c1a] mb-12">
                        ...
                        <div className="w-full flex gap-[5%] pb-12 border-b border-b-[#d4c3be71]">
                            ...
                            <div className="flex flex-col gap-3 w-[calc(100%-131.2px)]">
                                <div className="flex md:flex-row flex-col justify-between">
                                    <p className="font-noto md:text-[24px] text-[20px] leading-8 text-[#1a1c1a]">Silky Straight Virgin Wig</p>
                                    <p className="font-noto md:text-[20px] text-[18px] text-[#1a1c1a] leading-7">₦185,000</p>
                                </div>
                                <p className="text-[#827470] md:text-[14px] text-[13px] leading-5">Length: 22 inches • Color: Natural Black</p>
                                <p className="text-primary md:text-[14px] text-[13px] flex items-center gap-2 leading-4 font-medium"><Heart size={12} /> MOVE TO WISHLIST</p>
                    ...
                    <div className="px-8 py-8 flex flex-col gap-6 bg-[#F4F3F1] lg:w-[35%] md:w-[40%] w-full rounded-xl">
                        <p className="font-noto md:text-[24px] text-[22px] leading-8 pb-4 border-b border-b-[#d4c3be4f]">Order Summary</p>
                        <div className="*:flex *:justify-between *:space-y-4">
                            <div>
                                <p className="text-[18px] leading-6 text-[#827470]">Subtotal</p>
                                <p className="text-[16px] leading-6">197,000</p>
                            </div>
                            <div>
                                <p className="text-[18px] leading-6 text-[#827470]">Shipping</p>
                                <p className="text-[16px] leading-6 font-medium text-primary">Complimentary</p>
                            </div>
                            <div>
                                <p className="text-[18px] leading-6 text-[#827470]">Taxing (VAT)</p>
                                <p className="text-[16px] leading-6">0.00</p>
                            </div>
                            <div className="border-t  border-t-[#d4c3be4f] pt-4">
                                <p className="text-[18px] font-noto leading-7">Total</p>
