            ...
            <main className="flex flex-col items-center pt-15 bg-[#FCF9F8] h-fit">
                <div className="lg:w-[90%] w-[95%] font-manrope mb-20">
                    <section className="font-manrope w-full space-y-3 mb-20">
                        <h1 className="text-primary text-[12px] font-semibold leading-[14.4px] tracking-[1.2px]">STEP 02 — IDENTITY verification</h1>
                        <h2 className="font-noto text-[48px] leading-[52.8px] tracking-[-0.96px] font-bold">KYC & Verification</h2>
                        <div className="flex justify-between">
                            <p className="text-[18px] leading-[28.8px] w-1/2 text-light">To ensure the integrity of our luxury marketplace and secure escrow protections, please provide the following legal documentation for your boutique.</p>
                            <div className="flex justify-center gap-1 bg-gray-100 h-fit w-fit rounded border border-gray-200 p-4">
                                <ShieldCheck fill="blue" color="white" className="w-6 h-7" />
                                <div>
                                    <p className="text-[10px] leading-3 tracking-[0.8px] font-bold">DATA PRIVACY</p>
                                    <p className="text-[14px] leading-4.25 text-light">Encrypted & Guaranteed</p>
                                </div>
                            </div>
                        </div>
                    </section>
                    <section className="flex justify-between">
                        <section className="w-[25%] space-y-5">
                            <section className="bg-white border border-gray-100 p-6">
                                <h3 className="font-bodoni text-[24px] leading-[31.2px] font-medium mb-4">Image Guidelines</h3>
                                <ul className="*:flex *:gap-2 *:items-baseline *:text-[16px] space-y-4">
                        ...
                        <section className="w-[70%] flex flex-col gap-6">
                            <section className="p-6 bg-white border border-gray-200">
                                <h3 className="flex justify-between items-center font-bodoni text-[24px] font-medium leading-[31.2px]">Personal Identification <IdCardLanyard className="text-[#8E706E]" /></h3>
                            ...
                            <section className="p-6 bg-white border border-gray-200">
                                <h3 className="flex justify-between items-center font-bodoni text-[24px] font-medium leading-[31.2px]">Business Registration <House className="text-[#8E706E]" /></h3>
                            ...
                            <section className="p-6 bg-white border border-gray-200">
                                <h3 className="flex justify-between items-center font-bodoni text-[24px] font-medium leading-[31.2px]">Biometric Liveness <ScanFace className="text-[#8E706E]" /></h3>
                                ...
                                <section className="flex *:w-[48%] justify-between items-center">
                                    <div className="w-full h-85.25 relative">
                                    ...
                                    <div>
                                        <div className="bg-[#b0242918] border-l-4 p-4 h-fit border-primary mb-4">
                                            <p className="text-primary text-[12px] font-semibold leading-3.5 tracking-[0.6px] mb-2">PRO-TIP</p>
                                            <p className="text-[14px] leading-4.25 text-[#5A413F]">Hold the card without covering your name or photo with your fingers. Ensure our face is fully visible within the frame.</p>
                                        </div>
                            ...
                            <section className="flex justify-between">
                                <p className="text-[12px] font-semibold leading-[14.4px] tracking-[0.6px] flex gap-2 items-center"><ArrowLeft className="w-4 h-5" /> BACK TO STEP 1</p>
                                <p className="text-[10px] font-bold leading-3 tracking-[0.8px] flex gap-2 items-center"><LockKeyhole fill="blue" color="white" className="w-4 h-5" /> SECURE ENCRYPTION</p>
                                <button className="bg-button rounded-2xl text-white px-8 py-4 flex gap-2 items-center justify-center text-[12px] font-semibold leading-[14.4px] tracking-[1.2px]">SUBMIT FOR VERIFICATION <ArrowRight /></button>
                            </section>
                        </section>
                    </section>
                </div>
